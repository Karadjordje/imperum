	            ...
	            <div class="container main">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 col-md-offset-1 col-lg-offset-2">
                    	<div class="row">
                    		...
                    		<div class="col-xs-11 col-sm-10 col-md-10 col-lg-9 col-xs-offset-1 col-md-offset-1">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 col-lg-offset-1">
                		<table id="portfolioTable" class="text-uppercase col-md-9 col-md-offset-1">
                		    <tr>
                		        <td class="col-xs-4" align="right">Project name:</td>
                		        <td id="projectName" class="col-xs-8 addSpan"> <span class="dot">&#9679;</span></td>
                		    </tr>
                		    <tr>
                		        <td class="col-xs-4" align="right">Project link:</td>
                		        <td id="projectLink" class="col-xs-8 addSpan"> <span class="dot">&#9679;</span></td>
                		    </tr>
                		    <tr>
                		        <td class="col-xs-4" align="right">Category:</td>
                		        <td id="projectCategory" class="col-xs-8 addSpan"> <span class="dot">&#9679;</span></td>
                		    </tr>
                		    <tr>
                		        <td class="col-xs-4" align="right">Date:</td>
                		        <td id="projectDate" class="col-xs-8 addSpan"> <span class="dot">&#9679;</span></td>
                		    </tr>
                		    <tr>
                		        <td class="col-xs-4" align="right">Duration:</td>
                		        <td id="projectDuration" class="col-xs-8 addSpan"> <span class="dot">&#9679;</span></td>
                		    </tr>
                		</table>
                    </div>
	            </div>
