...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('visiblejs', get_template_directory_uri() . '/js/jquery.visible.min.js', array('jquery'), '1.0.0', true); // Custom scripts
        wp_enqueue_script('visiblejs'); // Enqueue it!

        wp_register_script('scrollTo', get_template_directory_uri() . '/js/jquery.scrollTo.min.js', array('jquery'), '1.0.0', true); // Custom scripts
...
// Create Custom Post type for Projects, called Projects Custom Post
function create_post_type_projects()
{
    register_taxonomy_for_object_type('category', 'projectsPost'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'projectsPost');
    register_post_type('projectsPost', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Projects Custom Post', 'ProjectsPost'), // Rename these to suit
            'singular_name' => __('ProjectsPost Custom Post', 'ProjectsPost'),
            'add_new' => __('Add New', 'ProjectsPost'),
            'add_new_item' => __('Add New ProjectsPost Custom Post', 'ProjectsPost'),
            'edit' => __('Edit', 'ProjectsPost'),
            'edit_item' => __('Edit ProjectsPost Custom Post', 'ProjectsPost'),
            'new_item' => __('New ProjectsPost Custom Post', 'ProjectsPost'),
            'view' => __('View ProjectsPost Custom Post', 'ProjectsPost'),
            'view_item' => __('View ProjectsPost Custom Post', 'ProjectsPost'),
            'search_items' => __('Search ProjectsPost Custom Post', 'ProjectsPost'),
            'not_found' => __('No ProjectsPost Custom Posts found', 'ProjectsPost'),
            'not_found_in_trash' => __('No ProjectsPost Custom Posts found in Trash', 'ProjectsPost')
        ),
        'public' => true,
        'hierarchical' => true, // Allows your posts to behave like Hierarchy Pages
        'has_archive' => true,
...
// This was added to count post views so we can create popular posts loop
